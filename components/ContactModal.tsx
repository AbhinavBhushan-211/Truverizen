                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-100 text-center">
                        <p className="text-xs text-slate-400">Prefer email? Reach us directly at <a href="mailto:sales@truverizen.ai" className="text-indigo-600 font-bold hover:underline">sales@truverizen.ai</a></p>
                    </div>
                  </form>
                )}
              </div>
